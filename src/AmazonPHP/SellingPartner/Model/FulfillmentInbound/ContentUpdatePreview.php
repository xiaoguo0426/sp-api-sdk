...
class ContentUpdatePreview implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @return self
     */
    public function setContentUpdatePreviewId($content_update_preview_id) : self
    {
     ...
     * @return self
     */
    public function setRequestedUpdates($requested_updates) : self
    {
     ...
     * @return self
     */
    public function setTransportationOption($transportation_option) : self
    {
