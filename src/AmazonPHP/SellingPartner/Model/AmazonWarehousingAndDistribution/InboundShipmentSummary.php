...
class InboundShipmentSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets created_at
     *
     * @param \DateTimeInterface|null $created_at Timestamp when the shipment was created.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTimeInterface|null $updated_at Timestamp when the shipment was updated.
     *
     * @return self
     */
