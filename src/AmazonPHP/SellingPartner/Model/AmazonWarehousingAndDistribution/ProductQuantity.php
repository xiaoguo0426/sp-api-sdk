...
class ProductQuantity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'attributes' => '\AmazonPHP\SellingPartner\Model\AmazonWarehousingAndDistribution\ProductAttribute[]',
        'quantity' => 'int',
        'sku' => 'string'
    ];
     ...
     * Gets attributes
     *
     * @return \AmazonPHP\SellingPartner\Model\AmazonWarehousingAndDistribution\ProductAttribute[]|null
     */
     ...
     * Sets attributes
     *
     * @param \AmazonPHP\SellingPartner\Model\AmazonWarehousingAndDistribution\ProductAttribute[]|null $attributes Attributes for this instance of the product. For example, already-prepped, or other attributes that distinguish the product beyond the SKU.
     *
     * @return self
     */
