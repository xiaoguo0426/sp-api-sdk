...
class ListOffersRequestPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function validate() : void
    {
        if ($this->container['limit'] === null) {
            throw new AssertionException("'limit' can't be null");
        }

        if (($this->container['limit'] > 100)) {
            throw new AssertionException("invalid value for 'limit', must be smaller than or equal to 100.");
        }

        if (($this->container['limit'] < 1)) {
            throw new AssertionException("invalid value for 'limit', must be bigger than or equal to 1.");
        }

        if ($this->container['offset'] === null) {
            throw new AssertionException("'offset' can't be null");
        }

        if (($this->container['offset'] > 9000)) {
            throw new AssertionException("invalid value for 'offset', must be smaller than or equal to 9000.");
        }
