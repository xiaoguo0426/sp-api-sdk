...
class LockerDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets locker_number
     *
     * @param string|null $locker_number Indicates the locker number
     *
     * @return self
     */
    public function setLockerNumber($locker_number) : self
    {
     ...
     *
     * @param string|null $locker_access_code Indicates the locker access code
     *
     * @return self
     */
    public function setLockerAccessCode($locker_access_code) : self
    {
