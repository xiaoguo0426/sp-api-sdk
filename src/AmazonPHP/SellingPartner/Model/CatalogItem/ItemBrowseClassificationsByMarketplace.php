...
class ItemBrowseClassificationsByMarketplace implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param \AmazonPHP\SellingPartner\Model\CatalogItem\ItemBrowseClassification[]|null $classifications Classifications (browse nodes) associated with the item in the Amazon catalog for the indicated Amazon marketplace.
     *
     * @return self
     */
