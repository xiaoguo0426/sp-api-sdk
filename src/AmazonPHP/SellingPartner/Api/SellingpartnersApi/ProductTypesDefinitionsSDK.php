...
final class ProductTypesDefinitionsSDK implements ProductTypesDefinitionsSDKInterface
{
    ...
    {
        $request = $this->getSellingPartnerMetricsRequest($accessToken, $region, $body);

        $this->configuration->extensions()->preRequest('ProductTypesDefinitions', 'getSellingPartnerMetrics', $request);
        ...
        try {
            ...
            if ($this->configuration->loggingEnabled('ProductTypesDefinitions', 'getSellingPartnerMetrics')) {
                $this->logger->log(
                    $this->configuration->logLevel('ProductTypesDefinitions', 'getSellingPartnerMetrics'),
            ...
            $this->configuration->extensions()->postRequest('ProductTypesDefinitions', 'getSellingPartnerMetrics', $request, $response);
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonPHP\SellingPartner\Model\ProductTypesDefinitions\GetSellingPartnerMetricsResponse',
            []
        );
    }
     ...
     */
    public function getSellingPartnerMetricsRequest(AccessToken $accessToken, string $region, $body = null) : RequestInterface
    {
